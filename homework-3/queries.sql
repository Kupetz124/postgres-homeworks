...
CONCAT(employees.first_name, ' ', employees.last_name) as employees_name
from customers
...
where products.discontinued = 0 and (categories.category_id = 4 or categories.category_id = 2) and products.units_in_stock < 25
